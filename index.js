...
let SimpleParseSmtpAdapter = (adapterOptions) => {
  ...
  let sendPasswordResetEmail = (data) => {
    let mail = {
      subject: adapterOptions.templates.resetPassword.subject,
    ...
    if (
      ...
      mail.text = data.link;
      if (adapterOptions.templates.resetPassword.render) {
        mail.text = adapterOptions.templates.resetPassword.render(data);
      }
      return sendMail(mail);
    }
  };
  ...
  let sendVerificationEmail = (data) => {
    let mail = {
      subject: adapterOptions.templates.verifyEmail.subject,
      to: getUserEmail(data.user),
    };
    ...
    if (
      ...
      mail.text = data.link;
      if (adapterOptions.templates.verifyEmail.render) {
        mail.text = adapterOptions.templates.verifyEmail.render(data);
      }
      return sendMail(mail);
    }
  };
